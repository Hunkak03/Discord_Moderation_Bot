...
![Groq](https://img.shields.io/badge/AI-Groq%20LLaMA-F55036?style=for-the-badge&logo=meta&logoColor=white)
...
Requisitos
Python 3.10+
Token de Discord (discord.com/developers)
...
Importa el repo desde railway.app
Ve a Variables y añade `DISCORD_TOKEN` y `GROQ_API_KEY`
En Settings → Start Command escribe: `python mybot.py`
¡Railway redesplegará automáticamente con cada `git push`!
---
⚙️ Configuración
...
---
☁️ Deploy on Railway
Import the repo from railway.app
Go to Variables and add `DISCORD_TOKEN` and `GROQ_API_KEY`
In Settings → Start Command write: `python mybot.py`
Railway will auto-redeploy on every `git push`!
---
📁 Project Structure
```
Mi-bot-testeo/
...
Made with ❤️ by Hunkak03
![GitHub](https://img.shields.io/badge/GitHub-Hunkak03-181717?style=for-the-badge&logo=github)
</div>
